            ...
            <section className="bg-white flex flex-wrap h-auto mx-auto border rounded my-16  shadow bg-cover" >
                <div id="profile"
                    ...
                    <div className="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <p className="pt-8 text-sm">Totally optional short description about yourself, what you do and
                            so on.</p>
                        ...
                        <div
                            ...
                            <a className="link" href="#" data-tippy-content="@facebook_handle">
                                <svg className="h-6 fill-current text-gray-600 hover:text-teal-700" role="img"
