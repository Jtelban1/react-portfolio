...
class Home extends React.Component {
    render() {
        ...
        return (
            <section className="bg-white flex flex-wrap h-auto mx-auto border rounded my-16  shadow bg-cover">
                <div
                    id="profile"
                ...
                >
                    <div className="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <p className="pt-8 text-sm text"></p>A Junior Web
                        Developer with a passion to keep learning and improving.
                        ...
                        <div className="flex">
                            ...
                            <div className="w-1/2">
                                <div className="flex mt-2">
                                    ...
                                    <p className="ml-4">
                                        <a href="https://github.com/jtelban1">
                                            GitHub account
                                        </a>
                                    </p>
                                </div>
                                <div className="flex mt-2">
                                    ...
                                    <p className="ml-4">
                                        <a href="https://www.linkedin.com/in/john-telban-4776b322/">
                                            linkedin Account
                                        </a>
                                    </p>
                                </div>
